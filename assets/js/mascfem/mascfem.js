function pestablecimientos(){
  ...
  if(!comprueba(tipo)) {
    ...
    if ((tipo=='2')||(tipo=='6')||(tipo=='8')){
      ...
      if (id=="99"){
        $.ajax({
          url:  base_url + '/Mascfem/pestablecimientosg',
          type: 'POST',
          async: true,
          data: { },
        ...
        $.ajax({
          url:  base_url + '/Mascfem/pestablecimientosf',
          type: 'POST',
          async: true,
          data: { estado: id },
          success: function(respuesta) {
    ...
    if ((tipo=='2')||(tipo=='3')||(tipo=='5')||(tipo=='8')||(tipo=='9')){
      ...
      $('#generar').attr('disabled' , true);      
        switch (tipo){
          case '4':
              $.ajax({
                url:  base_url + '/Mascfem/pserviciosg',
                type: 'POST',
                async: true,
                data: { },
                 success: function(respuesta) {
          ...
          case '6':
            var id=$('#estados').val();
            $.ajax({
              url:  base_url + '/Mascfem/pservicios_estado',
              type: 'POST',
              async: true,
              data: { estado: id },
              success: function(respuesta) {
          ...
          case '7':
            ...
            $.ajax({
              url:  base_url + '/Mascfem/pserviciosf',
              type: 'POST',
              async: true,
    ...
    if ((tipo=='2')||(tipo=='3')||(tipo=='4')||(tipo=='6')||(tipo=='7')){
      ...
      $('#generar').attr('disabled' , true);      
        switch (tipo){
          ...
          $.ajax({
            url:  base_url + '/Mascfem/pcargosestadof',
            type: 'POST',
            async: true,
          ...
          case '9':
            var establecimientos=$('#establecimientos').val();         
            $.ajax({
              url:  base_url + '/Mascfem/pcargosestablecimientof',
              type: 'POST',
              async: true,
...
function sgenerar() {
  ...
  if(!comprueba(tipo)) {
    ...
    switch (tipo){
      case '1':
            $.ajax({
              url:  base_url + '/Mascfem/gresex_general',
              type: 'POST',
              async: true,
              data: { },
              success: function(respuesta) {
      ...
      case '2':
            $.ajax({
              url:  base_url + '/Mascfem/gresex_general_estado',
              type: 'POST',
              async: true,
              data: { estado: estados },
              success: function(respuesta) {
      ...
      case '3':
            $.ajax({
              url:  base_url + '/Mascfem/gresex_general_establecimiento',
              type: 'POST',
              async: true,
      ...
      case '4':
            $.ajax({
              url:  base_url + '/Mascfem/gresex_general_servicios',
              type: 'POST',
              async: true,
      ...
      case '5':
       $.ajax({
              url:  base_url + '/Mascfem/gresex_general_cargos',
              type: 'POST',
              async: true,
              data: { cargo: cargos },
              success: function(respuesta) {
      ...
      case '6':
         $.ajax({
                  url:  base_url + '/Mascfem/gresex_servicios_estado',
                  type: 'POST',
                  async: true,
      ...
      case '7':
         $.ajax({
                  url:  base_url + '/Mascfem/gresex_servicios_establecimiento',
                  type: 'POST',
                  async: true,
      ...
      case '8':
         $.ajax({
                  url:  base_url + '/Mascfem/gresex_cargos_estado',
                  type: 'POST',
                  async: true,
      ...
      case '9':
         $.ajax({
                  url:  base_url + '/Mascfem/gresex_cargos_establecimiento',
                  type: 'POST',
                  async: true,
                  data: { establecimiento: establecimientos,cargo:cargos },
                  success: function(respuesta) {
...
function error_tipo() {
  $.ajax({
    url:  base_url + '/Mascfem/error_tipo',
    type: 'POST',
    async: true,
    data: {  },
    success: function(respuesta) {
...
function error_estado() {
  $.ajax({
    url:  base_url + '/Mascfem/error_estado',
    type: 'POST',
    async: true,
    data: {  },
    success: function(respuesta) {
...
function error_establecimiento() {
  ...
  $.ajax({
    url:  base_url + '/Mascfem/error_establecimiento',
    type: 'POST',
    async: true,
    data: { estado: estado },
    success: function(respuesta) {
...
function error_cargo() {
  var estado=$('#estados').val();
  $.ajax({
    url:  base_url + '/Mascfem/error_cargo',
    type: 'POST',
    async: true,
    data: { estado: estado },
    success: function(respuesta) {
...
function error_servicios() {
  var establecimientos=$('#establecimientos').val();
  $.ajax({
    url:  base_url + '/Mascfem/error_servicios',
    type: 'POST',
    async: true,
    data: { estado: estado },
    success: function(respuesta) {

function stipo() {
  ...
  if(med==1){
    ...
    if(tipo=="1"){
      ...
      if (tipo=="2"){
        $.ajax({
          url:  base_url + '/Restablecimientos/pestados',
          type: 'POST',
          async: true,
          data: { },
        ...
        $.ajax({
          url:  base_url + '/Restablecimientos/estadosp',
          type: 'POST',
          async: true,
          data: { },
          success: function(respuesta) {
...
function pestablecimientos(){
  var id=$('#estados').val();
    $.ajax({
      url:  base_url + '/Restablecimientos/pestablecimientos',
      type: 'POST',
      async: true,
      data: { estado: id },
      success: function(respuesta) {
...
function sgenerar() {
  ...
  if(med==1){
    ...
    if(tipo=="1"){
        var ruta= base_url + '/Restablecimientos/generar?tipo=1';    
        $.ajax({
          url:  base_url + '/Restablecimientos/button_pdf',
          type: 'POST',
          async: true,
          data: { ruta: ruta },
          success: function(respuesta) {
      ...
      if (tipo=="2"){
        ...
        var ruta= base_url + '/Restablecimientos/generar?tipo=2&estado='+ estado;    
        $.ajax({
          url:  base_url + '/Restablecimientos/button_pdf',
          type: 'POST',
          async: true,
        ...
        var ruta= base_url + '/Restablecimientos/generar?tipo=3&estado='+ estado + '&establecimiento=' + establecimiento;    
        $.ajax({
          url:  base_url + '/Restablecimientos/button_pdf',
          type: 'POST',
          async: true,
...
function error_estado() {
  $.ajax({
    url:  base_url + '/Restablecimientos/error_estado',
    type: 'POST',
    async: true,
    data: {  },
    success: function(respuesta) {
...
function error_establecimiento() {
  var estado=$('#estados').val();
  $.ajax({
    url:  base_url + '/Restablecimientos/error_establecimiento',
    type: 'POST',
    async: true,
    data: { estado: estado },
    success: function(respuesta) {

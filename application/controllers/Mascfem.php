<?php
class Mascfem extends MY_Controller {
	...
	public function index()
	{
		...
		if(empty($idsesion)){
			...
			$idcontrolador=$this->Controladores_model->get_id('Mascfem');
			$this->Sesion_model->actividad($idcontrolador,$idusuario , 1 , 5,$idsesion);		
			$data['estados']=$this->Ubicacion_model->select_estados();
			$this->load->model('Menu_model');
			$data['color']=$this->Menu_model->get_color('Mascfem');
			$this->add_view('mascfem/mascfem_inicial_view',$data);		
		}		
	}
	public function gresex_general()
	{
		...
		$tabla=$this->Gruposedadsexo_model->sex_general($id);
		$this->load->model('Menu_model');
		$data['id']=$id;		
		$data['color']=$this->Menu_model->get_color('Mascfem');
		$filas='';
		...
		endforeach;
		$data['filas']=$filas;
		$this->load->view('mascfem/grafico',$data);			
	}
	public function gresex_general_estado()
	{
		...
		$id=$this->Gruposedadsexo_model->get_id();
		$tabla=$this->Gruposedadsexo_model->sex_estado($id,$estado);
		$this->load->model('Menu_model');
		$data['id']=$id;		
		$data['color']=$this->Menu_model->get_color('Mascfem');
		$filas='';
	...
	public function gresex_general_establecimiento()
	{
		...
		$id=$this->Gruposedadsexo_model->get_id();
		$tabla=$this->Gruposedadsexo_model->sex_establecimiento($id,$establecimiento);
		$this->load->model('Menu_model');
		$data['id']=$id;		
		$data['color']=$this->Menu_model->get_color('Mascfem');
		$filas='';
	...
	public function gresex_general_servicios()
	{
		...
		$id=$this->Gruposedadsexo_model->get_id();
		$tabla=$this->Gruposedadsexo_model->sex_servicio($id,$servicio);
		$this->load->model('Menu_model');
		$data['id']=$id;		
		$data['color']=$this->Menu_model->get_color('Mascfem');
		$filas='';
	...
	public function gresex_general_cargos()
	{
		...
		$id=$this->Gruposedadsexo_model->get_id();
		$tabla=$this->Gruposedadsexo_model->sex_cargo($id,$cargo);
		$this->load->model('Menu_model');
		$data['id']=$id;		
		$data['color']=$this->Menu_model->get_color('Mascfem');
		$filas='';
	...
	public function gresex_servicios_estado()
	{
		...
		$servicio=$this->input->post('servicio');
		$id=$this->Gruposedadsexo_model->get_id();
		$tabla=$this->Gruposedadsexo_model->sex_servicio_estado($id,$servicio,$estado);
		$this->load->model('Menu_model');
		$data['id']=$id;		
		$data['color']=$this->Menu_model->get_color('Mascfem');
		$filas='';
	...
	public function gresex_servicios_establecimiento()
	{
		...
		$servicio=$this->input->post('servicio');
		$id=$this->Gruposedadsexo_model->get_id();
		$tabla=$this->Gruposedadsexo_model->sex_servicio_establecimiento($id,$servicio,$establecimiento);
		$this->load->model('Menu_model');
		$data['id']=$id;		
		$data['color']=$this->Menu_model->get_color('Mascfem');
		$filas='';
	...
	public function gresex_cargos_estado()
	{
		...
		$cargo=$this->input->post('cargo');
		$id=$this->Gruposedadsexo_model->get_id();
		$tabla=$this->Gruposedadsexo_model->sex_cargo_estado($id,$cargo,$estado);
		$this->load->model('Menu_model');
		$data['id']=$id;		
		$data['color']=$this->Menu_model->get_color('Mascfem');
		$filas='';
	...
	public function gresex_cargos_establecimiento()
	{
		...
		$cargo=$this->input->post('cargo');
		$id=$this->Gruposedadsexo_model->get_id();
		$tabla=$this->Gruposedadsexo_model->sex_cargo_establecimiento($id,$cargo,$establecimiento);
		$this->load->model('Menu_model');
		$data['id']=$id;		
		$data['color']=$this->Menu_model->get_color('Mascfem');
		$filas='';
	...
	public function pestados()
	{
		...
		$this->load->model('Menu_model');
		$data['color']=$this->Menu_model->get_color('Mascfem');
		$this->load->view('mascfem/estados',$data);				
	}
	public function estadosp()
	{
		...
		$this->load->model('Menu_model');
		$data['color']=$this->Menu_model->get_color('Mascfem');
		$this->load->view('mascfem/estadosp',$data);				
	}		
	public function pestablecimientosf()
	{
		...
		$this->load->model('Menu_model');
		$data['color']=$this->Menu_model->get_color('Mascfem');
		$this->load->view('mascfem/establecimientos',$data);				
	}
	...
	public function pcargosestadof()
	{
		...
		$this->load->model('Menu_model');
		$data['color']=$this->Menu_model->get_color('Mascfem');
		$this->load->view('mascfem/cargos_ok',$data);	
	}
	...
	public function pservicios_estado()
	{
		...
		$this->load->model('Menu_model');
		$data['color']=$this->Menu_model->get_color('Mascfem');
		$this->load->view('mascfem/servicios_ok',$data);	
	}
	...
	public function button_pdf()
	{
		...
		$this->load->model('Menu_model');
		$data['color']=$this->Menu_model->get_color('Mascfem');
		$this->load->view('mascfem/button_pdf',$data);				
	}
    public function error_tipo(){
       $this->load->view('mascfem/error_tipo');
    }	
    public function error_estado(){
		$this->load->model('Ubicacion_model');
		$estados=$this->Ubicacion_model->select_estados();
		$data['estados']=$estados;
       $this->load->view('mascfem/error_estados',$data);
    }
    public function error_cargo(){
       ...
       $this->load->view('mascfem/error_cargo',$data);
    }
    public function error_servicios(){
       ...
       $this->load->view('mascfem/error_servicios',$data);
    }             
    public function error_establecimiento(){
       ...
       $this->load->view('mascfem/error_establecimiento',$data);
    }   

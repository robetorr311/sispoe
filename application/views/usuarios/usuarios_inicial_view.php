    ...
    <script src="<?php echo base_url(); ?>assets/js/usuarios/usuarios.js"></script>    
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div id="cont_codigo">
                      <div class="input-group">
                        ...
                        <input type="text" name="login" id="login" class="form-control" disabled placeholder="LOGGIN">
                      </div>
                    </div>
                  </div><!-- /.col -->
                  <div class="col-md-6">
                  <div id="cont_nombre">
                    <div class="input-group">
                      ...
                      <input type="text" name="nombre" id="nombre" class="form-control" disabled placeholder="CONTRASEÑA">
                    </div>
                  </div>  
                  </div><!-- /.col --> 
                </div><!-- /.row -->                                                 

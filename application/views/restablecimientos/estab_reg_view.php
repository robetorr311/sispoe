                                  ...
                                  ?>
                                    <tbody>
                                      <tr>
                                        ...
                                        <td>
                                        <a type="button" class="btn btn-block btn-primary btn-xs" disabled onclick="bpractica('<?php echo $row->idpractica; ?>','<?php echo $row->idestablecimiento; ?>');">Borrar</a>
                                        </td>
                                      </tr>
                                    </tbody>                        
                                  <?php
              ...
              <div class="box-footer">
                  <button type="button" class="btn btn-primary" onclick="editar('<?php echo $codigo; ?>');">Modificar</button>
                  <button type="submit" class="btn btn-primary" disabled >Guardar</button>
                  <a type="button" href="<?php echo base_url(); ?>index.php/Establecimientos/index" class="btn btn-primary">Regresar</a>                  
              </div>
              </form>

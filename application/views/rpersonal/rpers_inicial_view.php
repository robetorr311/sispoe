    <script src="<?php echo base_url(); ?>assets/js/rpersonal/rpersonal.js"></script>     
        <section class="content">
          <div class="box box-default">
            <div class="box-header with-border <?php echo $color; ?>">
              <h3 class="box-title">
              Reporte de Personal Ocupacionalmente expuesto a Radiaciones          
              </h3>
            </div><!-- /.box-header -->
              <form>
              <div class="box-body">
                  ...
                  <div class="col-md-6">
                    <div id="cont_tipo">
                      <div class="input-group">
                        ...
                        <option value="2">PERSONAL POR ESTADOS</option>
                        <option value="3">PERSONAL POR ESTABLECIMIENTO</option>
                        </select>
                      </div>
                    </div>
                  </div><!-- /.col -->
